...
<head>
    <meta charset="UTF-8">
    <title>Staff Daily Time Record</title>
...
<body>
    <?php include('staff-navigation.php'); ?>

    <p class="classTitle fs-4 fw-bold ms-5 mb-2">Daily Time Record</p>
    ...
    <div class="container bg-white rounded border shadow mb-5 p-4">
        ...
        $adminFullName = '';
        // Fetch the first admin's name from admin_account
