...
$query = "SELECT * FROM `staff_account` WHERE `staff_id` = '$id'";
...
<nav class="navbar navbar-expand-lg" style="background-color: #44311f; height: 65px; width: 100%; position: fixed; top: 0; z-index: 1000;">
    <div class="container-fluid">
        ...
        <a class="navbar-brand text-white fw-bold fs-6 d-none ms-2 d-lg-block" href="staff-dashboard.php">Evalu8: A Faculty Evaluation System</a>
    ...
    <div class="modal-dialog modal-dialog-centered modal-md"> <!-- Default to modal-md for balanced appearance -->
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="manageAccountForm" method="POST" action="actions/edit-staff-account.php" enctype="multipart/form-data">
                    ...
                    <div class="container">
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                <label for="avatarInput" class="form-label"  style="font-size:0.875rem;">Profile Picture (Only use square image, 1:1 aspect ratio)</label>
                        ...
                        <?php if (isset($row) && !empty($row['avatar'])) { ?>
                            <div class="row mb-3">
                                <div class="col-12 text-center">
                                    <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['avatar']); ?>" alt="User Profile" class="rounded-circle img-fluid" style="width: 150px; height: 150px;">
                                </div>
                            </div>
                        <?php } ?>
