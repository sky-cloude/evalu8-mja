    ...
    <div class="container bg-white rounded border shadow mb-5 p-4">
        ...
        <div class="modal fade" id="addNewModal" tabindex="-1" aria-labelledby="addNewModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <form action="actions/add-breaktime.php" method="POST" id="addBreakTimeForm">
        ...
        <div class="modal fade" id="deleteBreakTimeModal" tabindex="-1" aria-labelledby="deleteBreakTimeModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <form id="deleteBreakTimeForm" method="POST" action="actions/delete-breaktime.php">
                    <div class="modal-content">
                        <div class="modal-header">
        ...
        <script>
            ...
            $('#editBreakTimeForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: 'actions/edit-breaktime.php',
                    type: 'POST',
                    data: formData,
                    dataType: 'json',
